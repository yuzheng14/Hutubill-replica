...
public class ChartUtil {
    ...
    private static String[] sampleLabels(List<Record> records) {
    ...
    public static Image getImage(List<Record> records, int width, int height) {
        //模拟样本数据
        ...
        //数据颜色
        Color[] sampleColors = new Color[]{ColorUtil.getBlue()};
        ...
        //图表整体背景颜色
        chart.setBackground(ColorUtil.getBackground());
        //把图表转换为Image类型
        return chart.getImage(width, height);

    }

    private static double[] sampleValues(List<Record> records) {
